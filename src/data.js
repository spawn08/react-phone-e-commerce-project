...
export const storeProducts = [
  {
    ...
    info:
      "The rohu is a species of fish of the carp family, found in rivers in South Asia. It is a large omnivore and extensively used in aquaculture.",
    inCart: false,
    count: 0,
    total: 0
  },
  {
    ...
    company: "B.I. Fisheries",
    info:
      "Katla, also known as the major South Asian carp, is an economically important South Asian freshwater fish in the carp family Cyprinidae.",
    inCart: false,
    count: 0,
    total: 0
  },
  ...
  },
  {
    ...
    company: "B.I. Fisheries",
    info:
      "Tilapia is the common name for nearly a hundred species of cichlid fish from the coelotilapine, coptodonine, heterotilapine, oreochromine, pelmatolapiine and tilapiine tribes (formerly all were in Tilapiini), with the economically most important species placed in Coptodonini and Oreochromini.",
    inCart: false,
    count: 0,
    total: 0
  },
